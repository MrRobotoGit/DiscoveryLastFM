...
# -*- coding: utf-8 -*-
"""
DiscoverLastfm.py · v1.7.6
– Integra Last.fm, MusicBrainz e Headphones            r = requests.get(
                url, params=params, timeout=30,
                headers={"User-Agent": "lfm2hp/1.7.6 (mr.roboto@example.com)"}
            ) scoprire e accodare album
...
# ─────────────────── CONFIG ───────────────────
LASTFM_USERNAME     = "MrRobotoPlus"
LASTFM_API_KEY      = "34c6312a48e44c5f51feaff1c6d011a9"

HP_API_KEY          = "638b21314f2122cccd3867edd2438532"
HP_ENDPOINT         = "http://192.168.1.2:8181"
...
def mbz_request(path, **params):
    ...
    for attempt in range(max_retries):
        try:
            ...
            r = requests.get(
                url, params=params, timeout=30,
                headers={"User-Agent": "lfm2hp/1.7.4 (mr.roboto@example.com)"}
            )
